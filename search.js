...
function displaySelectedRecord(item) {
    ...
    &nbsp;<p><centre><button id="downloadButton" onclick="fetchMissing()">Download Missing Images List</button></centre></p>&nbsp;<p><a href="https://canonn-science.github.io/undiscovered-codex/?cmdr=MISSING%20IMAGES">See on a Map<a></p>
    </div>
...
function fetchMissing() {
    ...
    // Clean up
    document.body.removeChild(a);
>>>>>>> 657f6b0 (Adding Zooming to the map)
};